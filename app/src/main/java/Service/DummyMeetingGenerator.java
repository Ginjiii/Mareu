...
public abstract class DummyMeetingGenerator {
    ...
    public static List<Meeting> DUMMY_MEETINGS = Arrays.asList(new Meeting("26/05/20", "13:00", "Mario", "Test", new ArrayList(Arrays.asList("alex@lamzone.com", "maxime@lamzone.com"))),
